...
public class ThreeWheelLocalizer extends Localizer {
    ...
    public ThreeWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(-81/25.4, 115.9/25.4, 0);
        rightEncoderPose = new Pose(-81/25.4, -115.9/25.4, 0);
        strafeEncoderPose = new Pose(-48/25.4, (21.1+24)/25.4, Math.toRadians(90));
