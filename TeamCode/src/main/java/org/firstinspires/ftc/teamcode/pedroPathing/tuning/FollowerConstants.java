...
public class FollowerConstants {
    ...
    private static double xMovement = 77.10497;
    private static double yMovement = 54.72746;
    ...
    public static double forwardZeroPowerAcceleration = -27.24125;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -68.257474;
